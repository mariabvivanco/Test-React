    ...
    return (
        <Flex justifyContent="center">
          <Box width="860px" borderRadius="lg" overflow="hidden">
            <Flex borderBottomWidth="1px" bg={colorMode === 'light' ?"gray.100":"gray.700"} padding="5px">
              <Text flex="2" fontSize="lg" fontWeight="bold" color={colorMode === 'light' ?"gray.800":"gray.500"}>Pregunta</Text>
              <Text flex="1" fontSize="lg" fontWeight="bold" color={colorMode === 'light' ?"gray.800":"gray.500"}>Respuesta correcta</Text>
              <Text flex="0 0 40px" fontSize="lg" fontWeight="bold" ></Text>
            </Flex>
            {test.map((item) => (
              <Flex borderBottomWidth="1px" padding="5px" key={item.question}>
                <Text flex="2" color={colorMode === 'light' ?"gray.800":"gray.500"}>{item.question}</Text>
